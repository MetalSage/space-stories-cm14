...
namespace Content.Client.Options.UI
{
    ...
    public sealed partial class OptionsMenu : DefaultWindow
    {
        ...
        public OptionsMenu()
        {
            ...
            Tabs.SetTabTitle(4, Loc.GetString("stories-ui-options-tts-label")); // Stories-TTS
            Tabs.SetTabTitle(5, Loc.GetString("rmc-ui-options-tab-voicelines")); // RMC14
        ...
        public void UpdateTabs()
        {
            ...
            TTSTab.Control.ReloadValues(); // Stories-TTS
