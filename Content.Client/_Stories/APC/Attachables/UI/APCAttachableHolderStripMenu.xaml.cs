...
public sealed partial class APCAttachableHolderStripMenu : FancyWindow
{
    ...
    public APCAttachableHolderStripMenu()
    {
    ...
    private void AddSlotControl(string slotId, Action<string> onPressed)
    {
        ...
        APCAttachablesContainer.AddChild(slotControl);
...
//                Texture = StaticIcons.GenericGear,
            ...
            {
                Text = Loc.GetString("st-apc-attachable-holder-strip-ui-empty-slot"),
            ...
            _infoButton = new Button
            {
                ...
                ToolTip = Loc.GetString("st-apc-attachable-holder-strip-ui-info-button-tooltip"),
                VerticalAlignment = VAlignment.Center
            };
