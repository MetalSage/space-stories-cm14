...
public sealed class RMCCrtPanel : PanelContainer, IRMCCrtThemedControl
{
    ...
    public float BackgroundOpacity { get => _backgroundOpacity; set { _backgroundOpacity = value; UpdateStyle(); } }
    ...
    public float BorderThickness { get => _borderThickness; set { _borderThickness = value; UpdateStyle(); } }
    public RMCCrtPanelVariant Variant { get => _variant; set { _variant = value; UpdateStyle(); } }
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        _effectsRenderer.Draw(handle, PixelWidth, PixelHeight, UIScale, Effects,
            ...
            RgbOpacity, _palette.Background.WithAlpha(0.3f));
    }
    ...
    private void UpdateStyle()
    {
        ...
        {
            RMCCrtPanelVariant.Inset => _palette.Background.WithAlpha(
                Math.Clamp(BackgroundOpacity + 0.15f, 0, 1)),
            RMCCrtPanelVariant.Surface => _palette.Background.WithAlpha(
