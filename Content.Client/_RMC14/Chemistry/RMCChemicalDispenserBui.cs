...
public sealed class RMCChemicalDispenserBui : BoundUserInterface
{
    ...
    public void Refresh()
    {
        ...
        _window.EnergyLabel.Text = Loc.GetString("ssmc-chem-disp-energy2", ("energy", energy.Int() ));
        ...
        {
            _window.BeakerStatus.Text = Loc.GetString("ssmc-chem-disp-no-beaker");
        ...
        else
        {
            ...
            if (_solution.TryGetMixableSolution(contained.Value, out _, out var solution))
            {
                ...
                foreach (var reagent in solution.Contents)
                {
                    ...
                    {
                        Text = Loc.GetString("ssmc-chem-disp-reagent-quantity", ("reagentname", reagentName), ("reagentquantity", reagent.Quantity)),
                    });
                }
            }

            _window.BeakerStatus.Text = Loc.GetString("ssmc-chem-disp-count-vs-max", ("units", units), ("maxunits", maxUnits));
        }
