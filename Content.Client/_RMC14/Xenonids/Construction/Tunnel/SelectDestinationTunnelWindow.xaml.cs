...
public sealed partial class SelectDestinationTunnelWindow : DefaultWindow
{
    ...
    public void UpdateSelectedTunnelDisplay(string? selectedTunnelName)
    {
        ...
        {
            SelectedTunnelLabel.Text = Loc.GetString("ssmc-xeno-tunnel-none");
            SelectedTunnelLabel.ToolTip = Loc.GetString("ssmc-xeno-tunnel-none");
        ...
        {
            var displayText = Loc.GetString("ssmc-xeno-tunnel-selected", ("tunnel", selectedTunnelName));
    ...
    public void UpdateCurrentTunnelDisplay(string? currentTunnelName)
    {
        var displayText = currentTunnelName != null
            ? Loc.GetString("ssmc-xeno-current-tunnel", ("tunnel",currentTunnelName))
            : Loc.GetString("ssmc-xeno-current-tunnel-unknown");
