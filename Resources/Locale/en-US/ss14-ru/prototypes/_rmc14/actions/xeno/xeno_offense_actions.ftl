...
ent-RMCGuidebookActionXenoScatteredSpit = { ent-CMGuidebookActionXenoBase }
    .desc = { ent-CMGuidebookActionXenoBase.desc }
ent-ActionXenoAcidShotgun = Acid shotgun (60)
    .desc = Launch a scatter shot of small acid blobs that fire damage enemies akin to spitter/praetorian spit. Targets restrained by traps take 75% increased damage.
...
ent-ActionXenoDeployTraps = Deploy Traps (60)
    .desc = Deploys a line of temporary resin traps that, when an enemy walks over, stuns them momentarily.
ent-ActionXenoDeployAcidMine = Acid Mine (40)
    .desc = Designate a tile in which a 3x3 acid mine will erupt. If anyone is in the 3x3 ranged acid mine, they'll be hit with acid.
