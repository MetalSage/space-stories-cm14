...
rmc-xeno-pheromones-help =
    ...
    Безумие (красный) — увеличивает скорость бега и урон.

    Защита (зеленый) — в критическом состоянии увеличивает максимальное отрицательное здоровье.

    Восстановление (синий) — увеличивает регенерацию плазмы и здоровья.
