...
rmc-award-recommendation-title = Рекомендация для награждения
rmc-award-recommendation-prompt = Кого бы вы хотели порекомендовать для награждения?
rmc-award-recommendation-reason = [bold]Почему вы рекомендуете этого человека?/bold]
rmc-award-recommendation-empty = Необходимо обосновать рекомендацию.
rmc-award-recommendation-invalid = Не удалось найти этого морского пехотинца.
rmc-award-recommendation-no-targets = В данный момент рекомендовать некого.
rmc-award-recommendation-no-computer = Не удалось сохранить рекомендацию.
rmc-award-recommendation-success = { $name } успешно рекомендован к награждению { $count }.
rmc-award-recommendation-out = Вы достигли лимита рекомендаций для награждения.
...
rmc-medal-panel-tab-give-medals = Вручить медали
rmc-medal-panel-tab-view-medals = Посмотреть медали
rmc-medal-panel-approve-recommendation = Одобрить
rmc-medal-panel-reject-recommendation = Отклонить
rmc-medal-panel-recommender-label = [color=#5B88B0]Запрашивающий:[/color]
