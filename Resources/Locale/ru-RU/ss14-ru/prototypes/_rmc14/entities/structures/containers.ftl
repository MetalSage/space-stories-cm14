...
ent-RMCContainerAegisRight = { ent-RMCContainerAegisLeft }
    .desc = { ent-RMCContainerAegisLeft.desc }
    .suffix = Эгида, Правый
ent-RMCContainerGrafLeft = грузовой контейнер
    .desc = Большой грузовой контейнер предназначенный для перевозки.
        Один из них стал полотном для уличных граффити.
    .suffix = Graffiti, Left
ent-RMCContainerGrafMiddle = { ent-RMCContainerGrafLeft }
    .desc = { ent-RMCContainerGrafLeft.desc }
    .suffix = Graffiti, Middle
ent-RMCContainerGrafRight = { ent-RMCContainerGrafLeft }
    .desc = { ent-RMCContainerGrafLeft.desc }
    .suffix = Graffiti, Right
ent-RMCContainerGraf2Left = { ent-RMCContainerGrafLeft }
    .desc = { ent-RMCContainerGrafLeft.desc }
    .suffix = Graffiti, Left
ent-RMCContainerGraf2Middle = { ent-RMCContainerGraf2Left }
    .desc = { ent-RMCContainerGraf2Left.desc }
    .suffix = Graffiti, Middle
ent-RMCContainerGraf2Right = { ent-RMCContainerGraf2Left }
    .desc = { ent-RMCContainerGraf2Left.desc }
    .suffix = Graffiti, Right
ent-RMCContainerGraf3Left = { ent-RMCContainerGrafLeft }
    .desc = { ent-RMCContainerGrafLeft.desc }
    .suffix = Graffiti, Left
ent-RMCContainerGraf3Middle = { ent-RMCContainerGraf3Left }
    .desc = { ent-RMCContainerGraf3Left.desc }
    .suffix = Graffiti, Middle
ent-RMCContainerGraf3Right = { ent-RMCContainerGraf3Left }
    .desc = { ent-RMCContainerGraf3Left.desc }
    .suffix = Graffiti, Right
ent-RMCContainerAvantLeft = грузовой контейнер Avant Biomedical
    .desc = Огромный промышленный грузовой контейнер. Он принадлежит компании Avant Biomedical, производящей биотехнологическую и медицинскую продукцию. Несмотря на репутацию производителя высококачественных товаров, компанию постоянно преследуют слухи о сомнительных проектах.
    .suffix = Avant, Left
...
ent-RMCContainerAMSRight = { ent-RMCContainerAMSLeft }
    ...
    .suffix = AMS, Правый
ent-RMCContainerMedicalLeft = медицинский грузовой контейнер
    .desc = Огромный промышленный транспортный контейнер. Он принадлежит компании Avant Biomedical, производящей медицинские товары и фармацевтическую продукцию.
    .suffix = Medical, Left
ent-RMCContainerMedicalEmptyRight = { ent-RMCContainerMedicalLeft }
    .desc = Небольшой фрагмент огромного промышленного транспортного контейнера.
    .suffix = Medical, Empty, Right
ent-RMCContainerMedicalRight = { ent-RMCContainerMedicalLeft }
    .desc = { ent-RMCContainerMedicalLeft.desc }
    .suffix = Medical, Right
