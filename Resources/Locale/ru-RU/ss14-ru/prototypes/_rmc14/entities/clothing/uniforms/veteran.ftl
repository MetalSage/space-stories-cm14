...
ent-RMCJumpsuitVeteranPMCEngineerNoWebbing = инженерный костюм ЧВК
    .desc = Черный рабочий костюм, разработанный для инженеров частной охранной компании. На костюме красуется символ корпорации Weston-Yamada.
...
ent-RMCJumpsuitVeteranPMCLeaderNoWebbing = камуфляжный командный костюм ЧВК
    .desc = Белый камуфляжный костюм, разработанный для сотрудников частных охранных компаний. На костюме красуется символ корпорации Weston-Yamada. Этот конкретный костюм выглядит так, будто принадлежит высокопоставленному офицеру.
