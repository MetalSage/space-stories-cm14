...
ent-RMCWeYaThermos = термос Ве-Я
    .desc = Элегантный металлический термос, украшенный цветами корпорации Вестон-Ямада. Маркетологи утверждают, что он выдерживает воздействие, эквивалентное ядерному взрыву, хотя это, вероятно, всего лишь рекламный ход.
