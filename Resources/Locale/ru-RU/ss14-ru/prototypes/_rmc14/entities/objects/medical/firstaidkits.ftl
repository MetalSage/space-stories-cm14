...
ent-CMFirstAidKitFilled = { ent-CMFirstAidKit }
    .desc = Это аптечка экстренной помощи, содержащая основные лекарства и экипировку. Для использования не требуется специального обучения. При наличии медицинской подготовки вы сможете уместить ее в рюкзаке.
    .suffix = Заполненный
