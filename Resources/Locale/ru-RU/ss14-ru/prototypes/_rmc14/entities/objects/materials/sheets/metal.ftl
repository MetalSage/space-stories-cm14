...
ent-CMSheetPlasteel = пласталь
    .desc = Пластсталь — это дорогой, прочный материал, созданный путем комбинирования платины, стали и передовых полимеров, чтобы получить металл, устойчивый к коррозии, очень прочный и легкий. Единственная причина, по которой его не используют чаще, — это то, насколько он чертовски дорогой.
    .suffix = Полный
