...
ent-RMCPortableGeneratorPacmanMachineCircuitBoard = плата портативного генератора П.А.К.М.А.Н.
    .desc = { ent-CMBaseMachineCircuitboard.desc }
ent-RMCPortableGeneratorSuperPacmanMachineCircuitboard = плата портативного генератора С.У.П.Е.Р.П.А.К.М.А.Н.
    .desc = { ent-CMBaseMachineCircuitboard.desc }
