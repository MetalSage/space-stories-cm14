...
ent-CMPouchFirstAidInjectors = { ent-CMPouchFirstAid }
    .desc = Содержит обезболивающий автоинъектор, автоинъектор для оказания первой помощи, несколько противоожоговых наборов и несколько бинтов.
    .suffix = Инжекторы
ent-CMPouchFirstAidFill = { ent-CMPouchFirstAid }
    .suffix = Заполненный
