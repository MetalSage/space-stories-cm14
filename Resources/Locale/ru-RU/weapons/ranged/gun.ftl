...
gun-ballistic-cycle-delayed = Вы начинаете разгрузку { CAPITALIZE(THE($entity)) }. Не двигаться...
gun-ballistic-cycle-delayed-cancelled = Вы прекращаете разгрузку { CAPITALIZE(THE($entity)) }.
