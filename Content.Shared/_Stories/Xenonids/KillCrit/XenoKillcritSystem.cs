...
public sealed class XenoKillcritSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<XenoKillcritComponent, XenoKillcritActionEvent>(OnXenoKillcritAction);
    }

    private void OnXenoKillcritAction(Entity<XenoKillcritComponent> xeno, ref XenoKillcritActionEvent args)
    {
        if (args.Handled)
            return;

        var attempt = new XenoKillcritAttemptEvent();
