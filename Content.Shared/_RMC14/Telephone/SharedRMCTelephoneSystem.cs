...
public abstract class SharedRMCTelephoneSystem : EntitySystem
{
    ...
    private void OnTelephoneCallMsg(Entity<RotaryPhoneComponent> ent, ref RMCTelephoneCallBuiMsg args)
    {
        ...
        {
            _popup.PopupEntity(Loc.GetString("ssmc-telephone-is-busy"), user, user, PopupType.MediumCaution);
            return;
        }
        ...
        {
            _popup.PopupEntity(Loc.GetString("ssmc-telephone-no-transmitters"), user, user, PopupType.MediumCaution);
            return;
        }
        ...
        {
            _popup.PopupEntity($"{marineMeta.EntityName} {Loc.GetString("ssmc-telephone-dials-number")} {phoneMeta.EntityName}.", ent);
        }
    ...
    public override void Update(float frameTime)
    {
        ...
        while (pickedUpPhonesQuery.MoveNext(out var uid, out var pickedUp, out var telephone))
        {
            ...
            {
                _popup.PopupEntity($"{Name(uid)} {Loc.GetString("ssmc-telephone-snap-back")} {Name(rotary)}!", uid, PopupType.MediumCaution);
            }
