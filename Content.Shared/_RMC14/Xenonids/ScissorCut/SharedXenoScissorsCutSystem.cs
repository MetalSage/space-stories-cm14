...
public abstract class SharedXenoScissorsCutSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<XenoScissorsCutComponent, XenoScissorsCutEvent>(OnXenoScissorsCut);

        Subs.CVar(_config, RMCCVars.RMCTailStabMaxTargets, v => _tailStabMaxTargets = v, true);
    }

    private void OnXenoScissorsCut(Entity<XenoScissorsCutComponent> stab, ref XenoScissorsCutEvent args)
    {
